...
custom.scss/node_modules/bootstrap/scss/bootstrap">
<custom.scss>
node_modules/
...
index.html
  ...
  #tuple of a set of frictional numbers
  sample4 = (fr(1,2),fr(2,3),fr(3,4),fr(5,6),fr(7,8))
  #tuple of a set of floting values
  sample5 = (1.23,1.45,2.1,2.2,1.9)
  #print the variance of each samples
  print("Variance of sample1 is %s"(varience(sample1)))
  print("Variance of sample2 is %s"(varience(sample2)))
  print("Variance of sample3 is %s"(varience(sample3)))
  print("Variance of sample4 is %s"(varience(sample4)))
  print("Variance of sample5 is %s"(varience(sample5)))
  <div class="dropdown" data-bs-theme="light">
  <button class="btn btn-secondary dropdown-toggle"type="button" id="dropdownmenubuttonlight" data-bs-toggle="dropdown" aria-expand="false">
  Default Dropdown
  </button>
  ...
  <li><a class="dropdown-item" herf="#">Separated link</a></li>
  </ul>
  </div>
  ...
  <label for="floatingselect">Work with selects</label>
  </div>
  <div class="form-floating mb-3">
  <input type="email" class="form-control" id="floatininputdisable" placeholder="name@example.com" disable>
  <label for="floatinginputdisable">Email address</label>
  </div>
  <div class="form-floating mb-3">
  <textarea class="form-control" placeholder="leave a comment here" id="floatingtextareadisabled" disabled></textarea>
  <label for="floatingtextareeadisabled">Comments</label>
  </div>
  <div class="form-floating mb-3">
  <textarea class="form-control" placeholder="leave a comment here" id="floatingtextare2disabled" style="height:100px" disabled>Disabled textarea with some text inside</textarea>
  ...
  <table class="table">
  <theadth scope="row">3</th scope="col">#</th>
